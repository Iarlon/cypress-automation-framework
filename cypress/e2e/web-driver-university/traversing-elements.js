describe("Traversing DOM elements in Cypress", () => {
  beforeEach(() => {
    ...
    it("nextAll() to get all of the next sibling DOM elements within elements", () => {
      cy.get('.traversal-drinks-list > #tea').nextAll().should('have.length', 3)
    });
  
    it("nextUntil() to get all of the next sibling DOM elements within elements until another element", () => {
      cy.get('.traversal-drinks-list > #coffee').nextUntil('#milk').should('have.length', 1)
    });
    ...
    it("prev() to get the previous sibling DOM element within elements", () => {
      cy.get('.traversal-drinks-list > #sugar').prev().should('contain', 'Espresso')
    });
    ...
    it("prevUntil() to get all previous sibling DOM elements within elements until other element", () => {
      cy.get('#veggie').nextUntil('#fruits').should('have.length', 4)
    });
